...
| `flutter_ai_client` | ⏳ planned | Provider abstraction + `UseChatController` (Listenable) |
| `flutter_ai_elements` | ⏳ planned | UI components + `AiThemeExtension` |
...
├── docs/                   # specs & roadmap
└── packages/
    └── flutter_ai_core/    # the foundation
```
